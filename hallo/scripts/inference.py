...
def inference_process(args: argparse.Namespace):
    ...
    # Disable gradient checkpointing for inference to save memory
    ...
    for t in range(times):
        ...
        tensor_result.append(pipeline_output.videos.cpu())
    ...
    if torch.cuda.is_available():
        ...
        print(f"Peak VRAM allocated: {vram_used:.2f} GB")
        print(f"Peak VRAM reserved: {vram_reserved:.2f} GB")
